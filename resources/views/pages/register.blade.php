...
<div class="flex items-center justify-center h-screen text-gray-600 bg-gray-50">
    ...
    <div class="py-16 px-48 bg-white rounded">
        ...
        <form action="#" method="post">
            ...
            <div class="mb-4">
                <input placeholder="Username" type="text" id="" name="" value="" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded focus:ring-blue-500 focus:border-blue-500 block w-64 p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            </div>
            <div class="mb-4">
                <input placeholder="Fullname" type="text" id="" name="" value="" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded focus:ring-blue-500 focus:border-blue-500 block w-64 p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <input placeholder="Confirm password" type="text" id="" name="" value="" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded focus:ring-blue-500 focus:border-blue-500 block w-64 p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            </div>
            <div class="mb-2">
