<div class="flex items-center justify-between rounded border-b border-gray-200 px-2 py-4 hover:bg-gray-100 hover:cursor-pointer">
    <div class="flex gap-4 items-center">
        ...
        <div>
            ...
            <p class="text-xs text-gray-500 mb-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, labore!</p>
